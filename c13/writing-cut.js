...
const SENTENCES = [
  ...
  '저희 "동사모"는 동물을 사랑하는 사람들이 모여서 버려진 동물들을 돌보는 일을 합니다.',
...
const RAW_CUTS = [
  ...
  { imgFile: 'c13-cut02.webp', alt: '동사모 회원들이 버려진 동물을 돌보는 장면', distractors: [0, 2, 6], dropSegments: ['저희 "', '"는 동물을 사랑하는 사람들이 모여서 버려진 동물들을 ', '.'], dropAnswers: ['동사모', '돌보는 일을 합니다'], dropChoices: ['동사모', '돌보는 일을 합니다', '사진을 전시해서', '많은 관심 부탁드립니다'], orderTokens: ['저희 "동사모"는', '동물을 사랑하는 사람들이 모여서', '버려진 동물들을 돌보는 일을 합니다.'], fillBlankAnswers: [['동사모'], ['돌보는 일을 합니다', '돌보는일을합니다']], fillPrompt: '저희 "[1]"는 동물을 사랑하는 사람들이 모여서 버려진 동물들을 [2].', hints: ['동사모', '버려진 동물', '돌보다'], requiredKeywords: ['동사모', '버려진 동물', '돌보'], acceptedPatterns: ['저희 "동사모"는 동물을 사랑하는 사람들이 모여서 버려진 동물들을 돌보는 일을 합니다.', '저희 동사모는 동물을 사랑하는 사람들이 모여서 버려진 동물들을 돌보는 일을 합니다.'] },
