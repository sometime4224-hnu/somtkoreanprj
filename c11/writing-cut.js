...
const LS_KEY = 'writing_cut_c11_modern_v1';
...
const RAW_CUTS = [
  { imgFile: 'c11-cut01.webp', alt: '회사에서 꼭 필요한 사람이 되고 싶어 하는 직장인', distractors: [1, 2, 3], dropSegments: ['직장인이라면 누구든지 ', ' 꼭 필요한 사람이 ', ' 싶을 것이다.'], dropAnswers: ['회사에서', '되고'], dropChoices: ['회사에서', '되고', '친절과 독서를', '해결한다'], orderTokens: ['직장인이라면 누구든지', '회사에서', '꼭 필요한 사람이', '되고', '싶을 것이다.'], fillBlankAnswers: [['회사에서'], ['되고']], fillPrompt: '직장인이라면 누구든지 [1] 꼭 필요한 사람이 [2] 싶을 것이다.', hints: ['회사', '필요한 사람', '직장인'], requiredKeywords: ['회사에서', '필요한 사람', '되고'], acceptedPatterns: ['회사에서 꼭 필요한 사람이 되고 싶어요.'] },
  { imgFile: 'c11-cut02.webp', alt: '어떤 노력이 필요한지 고민하는 직장인', distractors: [0, 2, 6], dropSegments: ['그런 사람이 되려면 ', ' 노력을 ', '?'], dropAnswers: ['어떤', '해야 할까'], dropChoices: ['어떤', '해야 할까', '친절과 독서를', '운이 좋다고'], orderTokens: ['그런 사람이 되려면', '어떤 노력을', '해야 할까?'], fillBlankAnswers: [['어떤'], ['해야 할까', '해야할까']], fillPrompt: '그런 사람이 되려면 [1] 노력을 [2]?', hints: ['그런 사람', '노력', '필요하다'], requiredKeywords: ['어떤 노력', '해야'], acceptedPatterns: ['그런 사람이 되려면 어떤 노력이 필요합니까?'] },
  { imgFile: 'c11-cut03.webp', alt: '성공하려면 친절과 독서를 실천해야 한다는 내용', distractors: [0, 10, 11], dropSegments: ["만약 회사에서 성공하고 싶다면 항상 '", "'과 '", "'를 실천해야 한다."], dropAnswers: ['친절', '독서'], dropChoices: ['친절', '독서', '서류', '우산'], orderTokens: ['만약 회사에서 성공하고 싶다면', '항상', "'친절'과 '독서'를", '실천해야 한다.'], fillBlankAnswers: [['친절'], ['독서', '독서를']], fillPrompt: "만약 회사에서 성공하고 싶다면 항상 '[1]'과 '[2]'를 실천해야 한다.", hints: ['성공', '친절', '독서'], requiredKeywords: ['성공', '친절', '독서'], acceptedPatterns: ['회사에서 성공하려면 항상 친절과 독서를 실천해야 합니다.'] },
  { imgFile: 'c11-cut04.webp', alt: '일을 맡기면 빨리 잘 해결하는 직장인', distractors: [4, 5, 14], dropSegments: ['회사에는 일을 맡기면 다른 사람보다 ', ' 잘 ', ' 사람이 있다.'], dropAnswers: ['빨리', '해결하는'], dropChoices: ['빨리', '해결하는', '기억했다가', '읽는다'], orderTokens: ['회사에는', '일을 맡기면', '다른 사람보다', '빨리 잘 해결하는', '사람이 있다.'], fillBlankAnswers: [['빨리'], ['해결하는']], fillPrompt: '회사에는 일을 맡기면 다른 사람보다 [1] 잘 [2] 사람이 있다.', hints: ['일을 맡기다', '빨리', '해결하다'], requiredKeywords: ['일을 맡기면', '빨리', '해결'], acceptedPatterns: ['회사에는 일을 맡기면 다른 사람보다 빨리 잘 해결하는 사람이 있어요.'] },
  { imgFile: 'c11-cut05.webp', alt: '어려운 일이 생겨도 도움을 받아 쉽게 해결하는 직장인', distractors: [3, 5, 6], dropSegments: ['그 사람은 어려운 일이 생겨도 ', '의 도움을 받아 ', ' 해결한다.'], dropAnswers: ['누군가', '쉽게'], dropChoices: ['누군가', '쉽게', '운이', '함께'], orderTokens: ['그 사람은', '어려운 일이 생겨도', '누군가의 도움을 받아', '쉽게 해결한다.'], fillBlankAnswers: [['누군가'], ['쉽게']], fillPrompt: '그 사람은 어려운 일이 생겨도 [1]의 도움을 받아 [2] 해결한다.', hints: ['어려운 일', '도움', '쉽게'], requiredKeywords: ['어려운 일', '도움', '쉽게'], acceptedPatterns: ['그 사람은 어려운 일이 생겨도 주변의 도움을 받아 쉽게 해결합니다.'] },
  { imgFile: 'c11-cut06.webp', alt: '사람들이 운이 좋다고 말하는 장면', distractors: [4, 6, 9], dropSegments: ['사람들은 그가 ', ' ', '.'], dropAnswers: ['운이 좋다고', '말한다'], dropChoices: ['운이 좋다고', '말한다', '실천해야 한다', '돕는다'], orderTokens: ['사람들은', '그가', '운이 좋다고', '말한다.'], fillBlankAnswers: [['운이 좋다고'], ['말한다']], fillPrompt: '사람들은 그가 [1] [2].', hints: ['사람들', '운이 좋다', '말하다'], requiredKeywords: ['운이 좋다', '사람들'], acceptedPatterns: ['사람들은 그 사람이 운이 좋다고 말합니다.'] },
  { imgFile: 'c11-cut07.webp', alt: '왜 좋은 일이 자주 생기는지 궁금해하는 사람들', distractors: [1, 5, 8], dropSegments: ['왜 그 사람에게만 ', ' 일이 ', '?'], dropAnswers: ['좋은', '자주 생길까'], dropChoices: ['좋은', '자주 생길까', '해야 할까', '기억한다'], orderTokens: ['왜', '그 사람에게만', '좋은 일이', '자주 생길까?'], fillBlankAnswers: [['좋은'], ['자주 생길까', '자주생길까']], fillPrompt: '왜 그 사람에게만 [1] 일이 [2]?', hints: ['왜', '좋은 일', '자주'], requiredKeywords: ['좋은 일', '자주', '왜'], acceptedPatterns: ['왜 그 사람에게만 좋은 일이 자주 일어날까요?'] },
  { imgFile: 'c11-cut08.webp', alt: '평소의 작은 친절이 원인이라는 것을 보여 주는 장면', distractors: [6, 9, 10], dropSegments: ['그 이유는 평소의 ', ' ', '이다.'], dropAnswers: ['작은 친절', '때문'], dropChoices: ['작은 친절', '때문', '독서', '회사'], orderTokens: ['그 이유는', '평소의', '작은 친절', '때문이다.'], fillBlankAnswers: [['작은 친절'], ['때문']], fillPrompt: '그 이유는 평소의 [1] [2]이다.', hints: ['이유', '작은 친절', '때문'], requiredKeywords: ['이유', '친절', '때문'], acceptedPatterns: ['그것은 평소의 작은 친절 때문입니다.'] },
  { imgFile: 'c11-cut09.webp', alt: '복사기와 서류와 우산으로 작은 친절을 보여 주는 장면', distractors: [1, 7, 13], dropSegments: ['복사기를 도와주고 ', ' 함께 들어 주고 ', ' 빌려주는 것은 아주 작은 일이다.'], dropAnswers: ['서류를', '우산을'], dropChoices: ['서류를', '우산을', '독서를', '운이'], orderTokens: ['복사기를 도와주고', '서류를 함께 들어 주고', '우산을 빌려주는 것은', '아주 작은 일이다.'], fillBlankAnswers: [['서류를'], ['우산을']], fillPrompt: '복사기를 도와주고 [1] 함께 들어 주고 [2] 빌려주는 것은 아주 작은 일이다.', hints: ['복사기', '서류', '우산'], requiredKeywords: ['복사기', '서류', '우산'], acceptedPatterns: ['복사기를 도와주고 서류를 함께 들어 주고 우산을 빌려주는 것은 아주 작은 일입니다.', '복사기를 도와주고 서류를 같이 들어 주고 우산을 빌려주는 것은 아주 작은 일입니다.'] },
  { imgFile: 'c11-cut10.webp', alt: '사람들이 친절을 오래 기억했다가 도와주는 장면', distractors: [5, 8, 10], dropSegments: ['사람들은 이런 작은 친절을 ', ' 기억했다가 나중에 그 사람을 ', '.'], dropAnswers: ['오래', '돕는다'], dropChoices: ['오래', '돕는다', '읽는다', '생긴다'], orderTokens: ['사람들은', '이런 작은 친절을', '오래 기억했다가', '나중에 그 사람을 돕는다.'], fillBlankAnswers: [['오래'], ['돕는다']], fillPrompt: '사람들은 이런 작은 친절을 [1] 기억했다가 나중에 그 사람을 [2].', hints: ['작은 친절', '오래 기억하다', '돕다'], requiredKeywords: ['친절', '오래 기억', '돕'], acceptedPatterns: ['사람들은 이런 작은 친절을 오래 기억했다가 나중에 그를 돕습니다.'] },
  { imgFile: 'c11-cut11.webp', alt: '친절한 사람이 더 성공할 가능성이 높다고 말하는 장면', distractors: [2, 7, 12], dropSegments: ['그래서 친절한 사람이 그렇지 않은 사람보다 ', ' 가능성이 ', '.'], dropAnswers: ['성공할', '높다'], dropChoices: ['성공할', '높다', '필요하다', '읽는다'], orderTokens: ['그래서', '친절한 사람이', '그렇지 않은 사람보다', '성공할 가능성이 높다.'], fillBlankAnswers: [['성공할'], ['높다']], fillPrompt: '그래서 친절한 사람이 그렇지 않은 사람보다 [1] 가능성이 [2].', hints: ['친절한 사람', '성공', '가능성'], requiredKeywords: ['친절한 사람', '성공', '가능성'], acceptedPatterns: ['그렇기 때문에 친절한 사람이 그렇지 않은 사람보다 성공할 가능성이 높습니다.'] },
  { imgFile: 'c11-cut12.webp', alt: '독서를 하는 사람이 성공한다는 제목 카드', distractors: [2, 10, 13], dropSegments: ['', ' 하는 사람이 ', '.'], dropAnswers: ['독서를', '성공한다'], dropChoices: ['독서를', '성공한다', '친절을', '읽는다'], orderTokens: ['독서를', '하는 사람이', '성공한다.'], fillBlankAnswers: [['독서를'], ['성공한다']], fillPrompt: '[1] 하는 사람이 [2].', hints: ['독서', '사람', '성공'], requiredKeywords: ['독서', '성공'], acceptedPatterns: ['독서를 하는 사람은 성공합니다.'] },
  { imgFile: 'c11-cut13.webp', alt: '한국 직장인이 1년에 평균 16권의 책을 읽는다는 그래프', distractors: [10, 11, 14], dropSegments: ['한국의 직장인들은 1년에 ', ' 16권의 책을 ', '.'], dropAnswers: ['평균', '읽는다'], dropChoices: ['평균', '읽는다', '친절', '생긴다'], orderTokens: ['한국의 직장인들은', '1년에', '평균 16권의 책을', '읽는다.'], fillBlankAnswers: [['평균'], ['읽는다']], fillPrompt: '한국의 직장인들은 1년에 [1] 16권의 책을 [2].', hints: ['직장인', '평균', '16권'], requiredKeywords: ['직장인', '평균', '16권'], acceptedPatterns: ['한국의 직장인들은 일 년에 평균 16권의 책을 읽습니다.'] },
  { imgFile: 'c11-cut14.webp', alt: '경제 경영 서적과 소설을 많이 읽는 직장인', distractors: [12, 10, 14], dropSegments: ['가장 많이 읽는 책의 종류는 ', '과 ', '이다.'], dropAnswers: ['경제 경영 서적', '소설'], dropChoices: ['경제 경영 서적', '소설', '복사기', '우산'], orderTokens: ['가장 많이 읽는 책의 종류는', '경제 경영 서적과', '소설이다.'], fillBlankAnswers: [['경제 경영 서적', '경제경영 서적', '경제경영서적'], ['소설']], fillPrompt: '가장 많이 읽는 책의 종류는 [1]과 [2]이다.', hints: ['책의 종류', '경제 경영 서적', '소설'], requiredKeywords: ['경제 경영 서적', '소설', '책'], acceptedPatterns: ['가장 많이 읽는 책의 종류는 경제경영 서적과 소설입니다.'] },
  { imgFile: 'c11-cut15.webp', alt: '경제 경영 서적을 읽으면 업무 지식을 얻는다는 장면', distractors: [3, 12, 13], dropSegments: ['경제 경영 서적을 읽으면 업무에 ', ' 지식을 ', ' 수 있다.'], dropAnswers: ['필요한', '얻을'], dropChoices: ['필요한', '얻을', '평균', '성공할'], orderTokens: ['경제 경영 서적을 읽으면', '업무에 필요한 지식을', '얻을 수 있다.'], fillBlankAnswers: [['필요한'], ['얻을']], fillPrompt: '경제 경영 서적을 읽으면 업무에 [1] 지식을 [2] 수 있다.', hints: ['경제 경영 서적', '업무', '지식'], requiredKeywords: ['경제 경영 서적', '업무', '지식'], acceptedPatterns: ['경제 경영 서적을 읽으면 업무에 필요한 지식을 얻을 수 있습니다.', '경제 경영 서적을 읽으면 새로운 아이디어를 얻고 성장 가능성을 생각할 수 있습니다.'] }
];
