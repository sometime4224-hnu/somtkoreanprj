const IMG_BASE = '../assets/c14/reading-writing/images/writing-cut/';
const LS_KEY = 'writing_cut_c14_modern_v1';
...
const PASSAGE_FULL_PARAGRAPHS = [
  ...
  '나무꾼은 지나가는 사람에게 자기 이름을 말하면서 그 사람을 아느냐고 물어보았다. 그 사람은 “그분은 제 아버지의 할아버지신데 나무하러 산에 갔다가 못 돌아오셨다고 들었습니다.” 하고 대답했다.',
  '나무꾼이 봤던 노인들은 신선들이었다. 신선들의 바둑을 잠깐 구경하는 동안에 100년의 시간이 지난 것이다.'
];
...
const RAW_CUTS = [
  { imgFile: 'c14-cut01.webp', alt: '깊은 산 동굴 앞에 선 나무꾼', distractors: [2, 6, 10], dropSegments: ['옛날에 어떤 ', '이 나무를 하러 산에 갔다가 ', '을 발견했다.'], dropAnswers: ['나무꾼', '동굴'], dropChoices: ['나무꾼', '동굴', '신선들', '마을'], orderTokens: ['옛날에 어떤 나무꾼이', '나무를 하러', '산에 갔다가', '동굴을 발견했다.'], fillBlankAnswers: [['나무꾼'], ['동굴']], fillPrompt: '옛날에 어떤 [1]이 나무를 하러 산에 갔다가 [2]을 발견했다.', hints: ['나무꾼', '산', '동굴'], requiredKeywords: ['나무꾼', '산', '동굴'], acceptedPatterns: ['옛날에 어떤 나무꾼이 나무하러 산에 갔다가 동굴을 발견했다.'] },
  { imgFile: 'c14-cut02.webp', alt: '작은 동굴 안쪽이 넓고 밝아지는 장면', distractors: [0, 3, 7], dropSegments: ['그 동굴은 입구는 작고 어두웠지만 들어가면 들어갈수록 점점 ', '지고 ', '졌다.'], dropAnswers: ['넓어', '밝아'], dropChoices: ['넓어', '밝아', '낡아', '변해'], orderTokens: ['그 동굴은 입구는 작고 어두웠지만', '들어가면 들어갈수록', '점점 넓어지고 밝아졌다.'], fillBlankAnswers: [['넓어', '넓어지고'], ['밝아', '밝아졌다']], fillPrompt: '그 동굴은 입구는 작고 어두웠지만 들어가면 들어갈수록 점점 [1]지고 [2]졌다.', hints: ['입구', '들어가면 들어갈수록', '넓고 밝다'], requiredKeywords: ['동굴', '들어가면 들어갈수록', '넓어지고 밝아졌다'], acceptedPatterns: ['그 동굴은 입구가 작고 어두웠지만 들어가면 들어갈수록 점점 넓어지고 밝아졌다.'] },
  { imgFile: 'c14-cut03.webp', alt: '동굴 안에서 수염이 긴 노인들이 바둑을 두는 장면', distractors: [1, 4, 8], dropSegments: ['그리고 동굴 안에서 ', '이 긴 노인들이 ', '을 두고 있었다.'], dropAnswers: ['수염', '바둑'], dropChoices: ['수염', '바둑', '도끼', '지붕'], orderTokens: ['그리고 동굴 안에서', '수염이 긴 노인들이', '바둑을 두고 있었다.'], fillBlankAnswers: [['수염'], ['바둑']], fillPrompt: '그리고 동굴 안에서 [1]이 긴 노인들이 [2]을 두고 있었다.', hints: ['동굴 안', '수염이 긴 노인', '바둑'], requiredKeywords: ['동굴', '노인', '바둑'], acceptedPatterns: ['동굴 안에서 수염이 긴 노인들이 바둑을 두고 있었다.'] },
  { imgFile: 'c14-cut04.webp', alt: '바둑이 재미있어서 시간 가는 줄 모르고 구경하는 나무꾼', distractors: [1, 5, 9], dropSegments: ['나무꾼은 바둑이 하도 ', '어서 시간 가는 줄 모르고 ', '을 했다.'], dropAnswers: ['재미있', '구경'], dropChoices: ['재미있', '구경', '어두웠', '대답'], orderTokens: ['나무꾼은 바둑이 하도 재미있어서', '시간 가는 줄 모르고', '구경을 했다.'], fillBlankAnswers: [['재미있어서', '재미있'], ['구경', '구경을 했다']], fillPrompt: '나무꾼은 바둑이 하도 [1]어서 시간 가는 줄 모르고 [2]을 했다.', hints: ['하도 재미있어서', '시간 가는 줄 모르다', '구경'], requiredKeywords: ['바둑', '하도 재미있어서', '시간 가는 줄 모르고'], acceptedPatterns: ['나무꾼은 바둑이 너무 재미있어서 시간 가는 줄 모르고 구경을 했다.'] },
  { imgFile: 'c14-cut05.webp', alt: '집에 돌아가려다 도끼를 보고 놀라는 나무꾼', distractors: [2, 7, 11], dropSegments: ['얼마 후 나무꾼은 집에 돌아가려고 ', '를 들다가 깜짝 ', '.'], dropAnswers: ['도끼', '놀랐다'], dropChoices: ['도끼', '놀랐다', '동굴', '지났다'], orderTokens: ['얼마 후 나무꾼은', '집에 돌아가려고', '도끼를 들다가', '깜짝 놀랐다.'], fillBlankAnswers: [['도끼'], ['놀랐다', '깜짝 놀랐다']], fillPrompt: '얼마 후 나무꾼은 집에 돌아가려고 [1]를 들다가 깜짝 [2].', hints: ['얼마 후', '도끼', '깜짝 놀라다'], requiredKeywords: ['나무꾼', '도끼', '놀랐다'], acceptedPatterns: ['얼마 후 나무꾼은 집에 돌아가려고 도끼를 들다가 깜짝 놀랐다.'] },
  { imgFile: 'c14-cut06.webp', alt: '자루가 없는 도끼를 들고 산을 내려오는 나무꾼', distractors: [0, 4, 10], dropSegments: ['그는 이상해하면서 ', '가 없는 도끼를 들고 산을 ', '.'], dropAnswers: ['자루', '내려왔다'], dropChoices: ['자루', '내려왔다', '나무꾼', '신선들'], orderTokens: ['그는 이상해하면서', '자루가 없는 도끼를 들고', '산을 내려왔다.'], fillBlankAnswers: [['자루'], ['내려왔다', '내려 왔다']], fillPrompt: '그는 이상해하면서 [1]가 없는 도끼를 들고 산을 [2].', hints: ['자루가 없다', '도끼', '산을 내려오다'], requiredKeywords: ['자루', '도끼', '내려왔다'], acceptedPatterns: ['그는 자루가 없는 도끼를 들고 산을 내려왔다.'] },
  { imgFile: 'c14-cut07.webp', alt: '완전히 달라진 마을에 도착한 나무꾼', distractors: [1, 5, 8], dropSegments: ['마을에 도착해 보니 집들이 완전히 ', ' 있었고 아는 사람도 전혀 ', '.'], dropAnswers: ['변해', '없었다'], dropChoices: ['변해', '없었다', '밝아', '물어보았다'], orderTokens: ['마을에 도착해 보니', '집들이 완전히 변해 있었고', '아는 사람도 전혀 없었다.'], fillBlankAnswers: [['변해', '변해 있었다'], ['없었다', '전혀 없었다']], fillPrompt: '마을에 도착해 보니 집들이 완전히 [1] 있었고 아는 사람도 전혀 [2].', hints: ['마을', '완전히 변하다', '아는 사람이 없다'], requiredKeywords: ['마을', '변해', '아는 사람도 전혀 없었다'], acceptedPatterns: ['마을에 도착해 보니 집들이 완전히 변했고 아는 사람도 전혀 없었다.'] },
  { imgFile: 'c14-cut08.webp', alt: '낡은 집과 지붕을 덮은 큰 나무를 보는 나무꾼', distractors: [2, 6, 11], dropSegments: ['나무꾼의 집도 ', ' 집이 되었고, 며칠 전에 심었던 나무가 크게 자라서 ', '을 덮고 있었다.'], dropAnswers: ['낡은', '지붕'], dropChoices: ['낡은', '지붕', '바둑', '100년'], orderTokens: ['나무꾼의 집도 낡은 집이 되었고,', '며칠 전에 심었던 나무가 크게 자라서', '지붕을 덮고 있었다.'], fillBlankAnswers: [['낡은', '낡다'], ['지붕']], fillPrompt: '나무꾼의 집도 [1] 집이 되었고, 며칠 전에 심었던 나무가 크게 자라서 [2]을 덮고 있었다.', hints: ['낡은 집', '크게 자란 나무', '지붕'], requiredKeywords: ['집', '낡은', '지붕'], acceptedPatterns: ['나무꾼의 집도 낡은 집이 되었고 며칠 전에 심었던 나무가 크게 자라 지붕을 덮고 있었다.'] },
  { imgFile: 'c14-cut09.webp', alt: '지나가는 사람에게 자기를 아느냐고 묻는 나무꾼', distractors: [0, 7, 10], dropSegments: ['나무꾼은 지나가는 사람에게 자기 ', '을 말하면서 그 사람을 아느냐고 ', '.'], dropAnswers: ['이름', '물어보았다'], dropChoices: ['이름', '물어보았다', '동굴', '신선들'], orderTokens: ['나무꾼은 지나가는 사람에게', '자기 이름을 말하면서', '그 사람을 아느냐고 물어보았다.'], fillBlankAnswers: [['이름'], ['물어보았다', '물어 봤다']], fillPrompt: '나무꾼은 지나가는 사람에게 자기 [1]을 말하면서 그 사람을 아느냐고 [2].', hints: ['지나가는 사람', '자기 이름', '물어보다'], requiredKeywords: ['나무꾼', '이름', '물어보았다'], acceptedPatterns: ['나무꾼은 지나가는 사람에게 자기 이름을 말하며 그 사람을 아느냐고 물어보았다.'] },
  { imgFile: 'c14-cut10.webp', alt: '지나가던 사람이 나무꾼에게 할아버지의 할아버지 이야기를 하는 장면', distractors: [3, 6, 11], dropSegments: ['그 사람은 “그분은 제 아버지의 ', '이신데 나무하러 산에 갔다가 못 돌아오셨다고 들었습니다.” 하고 ', '.'], dropAnswers: ['할아버지', '대답했다'], dropChoices: ['할아버지', '대답했다', '재미있어서', '100년'], orderTokens: ['그 사람은 “그분은 제 아버지의 할아버지신데', '나무하러 산에 갔다가', '못 돌아오셨다고 들었습니다.” 하고 대답했다.'], fillBlankAnswers: [['할아버지', '할아버지신데'], ['대답했다']], fillPrompt: '그 사람은 “그분은 제 아버지의 [1]이신데 나무하러 산에 갔다가 못 돌아오셨다고 들었습니다.” 하고 [2].', hints: ['아버지의 할아버지', '못 돌아오다', '대답하다'], requiredKeywords: ['아버지의 할아버지', '못 돌아오셨다', '대답했다'], acceptedPatterns: ['그 사람은 그분은 제 아버지의 할아버지신데 나무하러 산에 갔다가 못 돌아오셨다고 들었다고 대답했다.'] },
  { imgFile: 'c14-cut11.webp', alt: '나무꾼이 봤던 노인들이 신선들이었다는 장면', distractors: [1, 4, 9], dropSegments: ['나무꾼이 봤던 ', '들은 ', '들이었다.'], dropAnswers: ['노인', '신선'], dropChoices: ['노인', '신선', '어두웠지만', '대답했다'], orderTokens: ['나무꾼이 봤던', '노인들은', '신선들이었다.'], fillBlankAnswers: [['노인', '노인들'], ['신선', '신선들']], fillPrompt: '나무꾼이 봤던 [1]들은 [2]들이었다.', hints: ['노인들', '신선', '정체'], requiredKeywords: ['나무꾼', '노인', '신선'], acceptedPatterns: ['나무꾼이 보았던 노인들은 신선들이었다.'] },
  { imgFile: 'c14-cut12.webp', alt: '신선들의 바둑을 구경하는 동안 100년이 지난 장면', distractors: [0, 3, 8], dropSegments: ['신선들의 바둑을 잠깐 구경하는 동안에 ', '의 시간이 ', ' 것이다.'], dropAnswers: ['100년', '지난'], dropChoices: ['100년', '지난', '나무꾼', '물어보았다'], orderTokens: ['신선들의 바둑을', '잠깐 구경하는 동안에', '100년의 시간이 지난 것이다.'], fillBlankAnswers: [['100년', '백년'], ['지난', '지났다']], fillPrompt: '신선들의 바둑을 잠깐 구경하는 동안에 [1]의 시간이 [2] 것이다.', hints: ['신선들의 바둑', '잠깐 구경', '100년'], requiredKeywords: ['신선', '바둑', '100년'], acceptedPatterns: ['신선들의 바둑을 잠깐 구경하는 동안 100년의 시간이 지난 것이다.', '신선들의 바둑을 구경하는 동안에 100년이 지났다.'] }
];
...
function resolveImageSrc(cut) {
  ...
  const svg = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 675">
      ...
      <text x="600" y="240" text-anchor="middle" font-family="Noto Sans KR, sans-serif" font-size="42" font-weight="800" fill="#9a3412">14과 컷 ${cutNumber}</text>
  ...
  return `
    ...
    <section id="passage-dialog" class="passage-modal" role="dialog" aria-modal="true" aria-labelledby="passage-title" tabindex="-1">
      <div class="passage-head">
        <div>
          <div class="eyebrow">14과 읽기 지문</div>
          <h2 id="passage-title" class="passage-title">도낏자루 썩는 줄 모른다</h2>
